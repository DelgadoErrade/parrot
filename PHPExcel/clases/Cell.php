...
require_once PHPEXCEL_ROOT . 'clases/Cell/DataValidation.php';

/** PHPExcel_Cell_Hyperlink */
require_once PHPEXCEL_ROOT . 'clases/Cell/Hyperlink.php';

/** PHPExcel_Worksheet */
require_once PHPEXCEL_ROOT . 'clases/Worksheet.php';

/** PHPExcel_Calculation */
require_once PHPEXCEL_ROOT . 'clases/Calculation.php';

/** PHPExcel_Cell_IValueBinder */
require_once PHPEXCEL_ROOT . 'clases/Cell/IValueBinder.php';

/** PHPExcel_Cell_DefaultValueBinder */
require_once PHPEXCEL_ROOT . 'clases/Cell/DefaultValueBinder.php';
